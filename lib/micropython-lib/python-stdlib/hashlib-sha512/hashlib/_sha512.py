...
class sha512(sha):
    ...
    def _transform(self):
        ...
        def RND(a, b, c, d, e, f, g, h, i, ki):
            t0: "int" = (h + Sigma1(e) + Ch(e, f, g) + ki + W[i]) & 0xFFFFFFFFFFFFFFFF
            t1: "int" = (Sigma0(a) + Maj(a, b, c)) & 0xFFFFFFFFFFFFFFFF
    ...
    def _update(self, buffer):
        ...
        count = len(buffer)
        buffer_idx = 0
        clo: "int" = (self._count_lo + (count << 3)) & 0xFFFFFFFF
    ...
    def _final(self):
        lo_bit_count: "int" = self._count_lo
        hi_bit_count: "int" = self._count_hi
